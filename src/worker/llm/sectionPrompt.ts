...
const SECTION_BLOCKS: Record<CanonicalSectionId, string> = {
  ...
  sup_valuation_detail: [
    ...
    "  Report a SINGLE current and SINGLE forward multiple per row — never a wide range. When current price isn't verified from a primary source, write 'current price not verified from a primary source' rather than invent.",
